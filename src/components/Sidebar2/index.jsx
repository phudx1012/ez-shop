...
export default function Sidebar2({ ...props }) {
  ...
  return (
    <Sidebar
      ...
      collapsed={collapsed}
      className={`${props.className} flex flex-col h-screen mt-[60px] top-0 !sticky overflow-auto md:hidden`}
    >
      <Menu
        menuItemStyles={{
          button: {
        ...
        <div>
          ...
          <div>
            <div className="flex items-start">
              ...
              <Text
                as="p"
                className="relative ml-[-185px] mt-[715px] w-[29%] leading-[55px]"
              >
                <>
                  Bảng quản lý <br /> Các sản phẩm <br /> Đặt hàng <br /> Khách
                  hàng <br /> Thể loại <br /> Cài đặt <br /> Đăng xuất
                </>
              </Text>
            </div>
          </div>
