...
export default function DashboardPage() {
  const table6Columns = React.useMemo(() => {
    ...
    return [
      table6ColumnHelper.accessor("id", {
        cell: (info) => (
          <Text size="lg" as="p">
            {info?.getValue?.()}
          </Text>
      ...
      table6ColumnHelper.accessor("snphm", {
        cell: (info) => (
          <Text size="lg" as="p">
            {info?.getValue?.()}
          </Text>
      ...
      table6ColumnHelper.accessor("ngy", {
        cell: (info) => (
          <Text size="lg" as="p">
            {info?.getValue?.()}
          </Text>
      ...
      table6ColumnHelper.accessor("thanhton", {
        cell: (info) => (
          <Text size="lg" as="p">
            {info?.getValue?.()}
          </Text>
      ...
      table6ColumnHelper.accessor("tnhtrng", {
        cell: (info) => (
          <div className="flex">
            <Button
              color="gray_50_04"
      ...
      table6ColumnHelper.accessor("tng", {
        cell: (info) => (
      ...
      table6ColumnHelper.accessor("thm", {
        cell: (info) => (
          <div className="flex">
            <Img
              src={info?.getValue?.()}
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex items-start gap-[30px] md:flex-col">
            ...
            <div className="flex flex-1 flex-col items-center gap-[29px] md:self-stretch">
              <div className="flex flex-col gap-[30px] self-stretch rounded-[16px] bg-gray-100_05 px-[52px] pb-[60px] pt-[52px] md:p-5">
                <div>
                  <div className="flex flex-col gap-[30px]">
                    <div className="flex flex-col gap-[37px]">
                      ...
                      <div className="flex gap-[30px] md:flex-col">
                          ...
                          <div className="flex flex-1 flex-col items-start gap-[15px]">
                            ...
                            <div className="flex flex-wrap gap-1">
                              ...
                              >
                                ...
                                <a
                                  href="#"
                                  className="text-green-A700_02 underline"
                                >
                                  đ
                                </a>
                              </Text>
                            ...
                            <div className="relative mt-[-3px] flex gap-[3px]">
                              ...
                              <div className="flex flex-col self-end">
                                ...
                                <Text
                                  size="md"
                                  as="p"
                                  className="relative mt-[-18px] !text-blue_gray-600"
                                >
                                  Đơn hàng mới
                                </Text>
                              </div>
                        ...
                        <div className="flex rounded-[16px] bg-white-A700 pb-[39px] pl-[22px] pr-[21px] pt-[22px] shadow-3xl sm:p-5">
                          <div className="flex flex-col items-start">
                            <div className="relative z-[2] flex items-end">
                              <div className="mb-[18px] flex flex-col items-start gap-[25px]">
                                <Heading as="h6" className="uppercase">
                                  Số dư của ví
                                </Heading>
                                <Heading size="5xl" as="h5">
                              ...
                              <Button
                                ...
                                className="mb-[18px] ml-[41px] min-w-[60px] gap-0.5"
                              >
                                2.2%
                              </Button>
                              <Button
                    ...
                    <div className="flex gap-[30px] md:flex-col">
                      ...
                      <div className="flex w-[33%] flex-col gap-11 rounded-[16px] bg-white-A700 px-[29px] pb-[79px] pt-[29px] shadow-3xl md:w-full md:pb-5 sm:p-5">
                        ...
                        <div className="flex items-start justify-between gap-5">
                          <div className="mt-[26px] flex w-[22%] flex-col gap-[30px]">
                            <div className="flex flex-col items-start">
                            ...
                            <div className="flex w-[56%] flex-col items-start gap-[3px] md:w-full">
                              <div className="flex items-start gap-2 self-stretch">
                          ...
                          <div className="flex h-[227px] flex-col items-center justify-center bg-[url(/public/images/img_group_4128.svg)] bg-cover bg-no-repeat pb-24 pl-10 pr-9 pt-[94px] md:h-auto md:py-5 sm:p-5">
                ...
                <div className="flex gap-[30px] md:flex-col">
                  <div className="flex flex-1 flex-col items-start gap-9 rounded-[16px] bg-white-A700 px-[30px] pb-[30px] pt-[26px] shadow-3xl md:self-stretch sm:p-5">
                    <Text size="2xl" as="p" className="uppercase">
                      đơn hàng gần đây
                    </Text>
                    <ReactTable
                    ...
                    <div className="flex flex-col self-stretch">
                      <div>
                        <div className="flex items-start gap-[11px] sm:flex-col">
                          ...
                          >
                            <>
                              Thanh toán bởi Ali Price <br /> Sản phẩm đồng hồ
                              thông minh
                            </>
                          </Text>
                        </div>
                      ...
                      <div className="flex w-[88%] md:w-full">
                        <div className="flex w-full items-start gap-[11px]">
                          ...
                          <div className="flex flex-1 flex-col gap-1.5">
                            ...
                            >
                              <>
                                Đã thêm bộ sưu tập phong cách mới <br /> Bởi TFN
                                Technologies
                              </>
                            </Text>
                      ...
                      <div className="flex w-[60%] flex-col items-start md:w-full">
                        <div className="flex items-center gap-[11px] self-stretch">
                          ...
                          <div className="h-[13px] w-[13px] self-start rounded-md border-[3px] border-solid border-red-A200" />
                      ...
                      <div className="flex flex-col gap-px">
                        <div className="flex flex-1 items-center gap-[11px] sm:flex-col">
                          ...
                          >
                            <>
                              Natasha Carey đã thích sản phẩm. <br /> Cho phép
                              người dùng thích sản phẩm trong cửa hàng của bạn.
                            </>
                          </Text>
                        </div>
                        <div className="flex flex-1 items-start gap-2.5 sm:flex-col">
                          ...
                          >
                            <>
                              Sản phẩm được yêu thích <br /> Esther James có sản
                              phẩm yêu thích.
                            </>
                          </Text>
                        </div>
                        <div className="flex flex-1 items-start sm:flex-col">
                          ...
                          >
                            <>
                              Ưu đãi hôm nay của Digitech Galaxy <br /> Ưu đãi
                              chỉ áp dụng cho đơn hàng từ 500 Rupee trở lên.
                            </>
                          </Text>
                        </div>
                      </div>
